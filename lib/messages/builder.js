...
function builder(options) {
  ...
  if (!options.network) {
    options.network = auroracoin.Networks.defaultNetwork;
  }

  options.Block = options.Block || auroracoin.Block;
  options.BlockHeader = options.BlockHeader || auroracoin.BlockHeader;
  options.Transaction = options.Transaction || auroracoin.Transaction;
  options.MerkleBlock = options.MerkleBlock || auroracoin.MerkleBlock;
